...
# select_1 = ["Video", "Audio"]
# while True:
#     print("Select Download Video or Audio")
#     for num, sel in enumerate(select_1):
#         print(f"[{num}]: {sel}")

#     sel1 = int(input("...(9: exit): "))
#     subprocess.call(clear)
...
while True:
    ...
    if res_select >=6:
        ...
        subprocess.call(clear)
if sel0 == 0:
    youtube_url(res_select, stream, types="video")

if sel0 == 1:
    youtube_playlist(res_select, stream, types="video")
